...
Welcome to our Github presence! Beeper is a universal messaging app that lets you chat with anyone on any chat app, including Whatsapp, iMessage, Telegram and 12 others. Want to use Beeper? Learn more and download it on [beeper.com](https://beeper.com).

### Open source
Beeper is built on top of an open source chat protocol called [Matrix](https://matrix.org). When we started building Beeper, we made a fundamental decision to open source our backend code and provide you with the option to self-host Beeper. We chose to do this because:
- We want you to be verify the source code that Beeper uses to connect to other chat networks (hopefully enabling you to trust Beeper more),
- We want to contribute to the Matrix ecosystem, and
